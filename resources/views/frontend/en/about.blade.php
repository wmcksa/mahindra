...
<div
    ...
    >
      <div class="container">
        <h1 class="title fw-bold display-6 m-0">About Us</h1>
      </div>
    </div>

    <section class="welcome">
      <div class="container">
        <h2 class="head-title display-6">Why mahindra</h2>

        <p class="text mb-0">
          {{$content->about_section_content_en}}
        </p>
      </div>
    </section>
          ...
          <div class="col-md-6 slogan-s">
            <div class="about-features">
              ...
              <div class="feature-card">
                ...
                <div class="content">
                  <h3 class="title h4 mb-3 fw-bold">{{$content->about_point3_en}}</h3>
                  <small class="text">
                  {{$content->desc3_en}}
                  </small>
                </div>

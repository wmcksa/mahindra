...
@section('content')
 ...
 <div
    ...
    >
      <div class="container">
        <h1 class="title fw-bold display-6 m-0">Dealer Locator</h1>
      </div>
    </div>

    <section class="dealer-locator">
      <div class="container">
        <h2 class="head-title display-6">Find Mahindra Dealers Near You</h2>
              ...
              @forelse ($dealerlocators as $dealerlocator)
                ...
                >
                  ...
                  <ul class="contact-links">
                    <li>
                      <p>Working Days: {{$dealerlocator->beginning_working_day}} To {{$dealerlocator->end_working_day}}</p>
                    </li>

                    <li>
                      <p>Working Hours: {{$dealerlocator->beginning_working_hours}} To {{$dealerlocator->end_working_hours}}</p>
                    </li>

        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3 class="modal-title">
                    <span id="lblRequestMoreInfo">Request More Info</span>
                </h3>
            </div>
            <div class="modal-body">
                {{-- <form action="post.php" method="POST"> --}}
                    ...
                    <div class="form-group" hidden>
                        ...
                        <input name="form_type" id="ContentPlaceHolder_messagewdwd"
                            class="form-control custom-height white_bg" rows="4" value="4">
                    </div>

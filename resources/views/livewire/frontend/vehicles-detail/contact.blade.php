    ...
    <section class="contact_us section-padding">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <h4 class="title">
                        <span id="ContentPlaceHolder_lblGetIntouch">تواصل معنا باستخدام النموذج أدناه</span>
                    </h4>
                    <div class="contact_form gray-bg">
                        {{-- <form action="#" method="POST"> --}}
                            ...
                            <div class="form-group" hidden>
                                <label class="control-label">
                                    <input name="form_type" type="text" id="ContentPlaceHolder_name"
                                        class="form-control white_bg" value="1" />
                            </div>
                ...
                <div class="col-md-6">
                    <h4 class="title">
                        <span id="ContentPlaceHolder_lblContactInfo">معلومات الاتصال</span>
                    </h4>
                        ...
                        <ul>
                            <li>
                                ...
                                <div class="contact_info_m">
                                    <span id="ContentPlaceHolder_lblPOBox">الخبر- المملكة العربية
                                        السعودية</span>
                                </div>
                            </li>
                            <li>
